# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-05-05 00:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('public', models.BooleanField(default=False, verbose_name='Make assessment details visible to everyone in the company?')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                'permissions': (('view_assessment_interview', 'Can view AssessmentInterview'), ('edit_assessment_interview', 'Can edit AssessmentInterview')),
            },
        ),
        migrations.CreateModel(
            ...
            options={
                'permissions': (('view_assessment_interview_result', 'Can view AssessmentInterviewResult'), ('edit_assessment_interview_result', 'Can edit AssessmentInterviewResult')),
                'ordering': ('-updated',),
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            options={
                'permissions': (('view_assessment_log_event', 'Can view AssessmentLogEvent'), ('edit_assessment_log_event', 'Can edit AssessmentLogEvent')),
                'ordering': ('-created',),
            },
        ),
        migrations.CreateModel(
            ...
            options={
                'permissions': (('view_candidate', 'Can view Candidate'), ('edit_candidate', 'Can edit Candidate')),
        ...
        migrations.CreateModel(
            ...
            options={
                'permissions': (('view_employee', 'Can view Employee'), ('edit_employee', 'Can edit Employee')),
                'ordering': ('-user__date_joined',),
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            options={
                'permissions': (('view_interview', 'Can view Interview'), ('edit_interview', 'Can edit Interview')),
                'ordering': ('-start',),
            },
        ),
        migrations.CreateModel(
            ...
            options={
                'permissions': (('view_office', 'Can view Office'), ('edit_office', 'Can edit Office')),
                'ordering': ('-name',),
            },
        ),
        migrations.CreateModel(
            ...
            options={
                'permissions': (('view_result', 'Can view Result'), ('edit_result', 'Can edit Result')),
                'ordering': ('-updated',),
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            options={
                'permissions': (('view_room', 'Can view Room'), ('edit_room', 'Can edit Room')),
                'ordering': ('-name',),
            },
        ),
        migrations.CreateModel(
